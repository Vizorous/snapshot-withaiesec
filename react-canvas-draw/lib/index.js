    ...
    function _default(props) {
      ...
      _this.handleCanvasResize = function (entries, observer) {
        ...
        for (
          ...
          _this.drawGrid(_this.ctx.drawing);
      ...
      _this.handlePointerMove = function (x, y) {
        ...
        if (
          (_this.isPressing && hasChanged && !_this.isDrawing) ||
      ...
      _this.drawPoints = function (_ref3) {
        ...
        _this.ctx.temp.shadowColor = "#000";
        _this.ctx.temp.shadowBlur = 5;
      ...
      _this.drawGrid = function (ctx) {
        ...
        ctx.lineWidth = _this.props.lineWidth;
        ctx.stroke();
