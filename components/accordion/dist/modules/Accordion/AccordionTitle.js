...
var AccordionTitle = /*#__PURE__*/function (_Component) {
  ...
  var _super = _createSuper(AccordionTitle);
  ...
  function AccordionTitle() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleClick", function (e) {
      return _lodash["default"].invoke(_this.props, 'onClick', e, _this.props);
    });
  ...
  _createClass(AccordionTitle, [{
    ...
    value: function render() {
      ...
      var iconValue = _lodash["default"].isNil(icon) ? 'dropdown' : icon;
...
_defineProperty(AccordionTitle, "propTypes", {
